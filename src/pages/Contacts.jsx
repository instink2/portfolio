        ...
        <Col md={6} className="mx-auto">
          <Card>
            <Card.Body>
              ...
              <Card.Text>
                <strong>Name:</strong> Cristine Lynnette Buenaagua
              </Card.Text>
              <Card.Text>
                <strong>Email:</strong> <a href="mailto:buenaaguatinn@gmail.com">buenaaguatinn@gmail.com</a>
              </Card.Text>
              <Card.Text>
                <strong>Phone:</strong> 09455776423
              </Card.Text>
